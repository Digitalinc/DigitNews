                        ...
                        <form class="message form send_message_form" method="get" action="">
                            <div class="fields clearfix">
                                <div class="input">
                                    ...
                                    <input id="forgotpass-email" type="email" placeholder="Email Address" name="forgotpassemail" required>
                                </div>
                            </div>
                        </form>
                        <div class="clearfix"></div>
                        <div class="forgot_pass_btn">
                            <div style="float: left"><button id="forgotpassbtn" onclick="forgotpass_action();">Send Reset Link</button></div>
                            <div style="float: right;display: none;" class="forgot_pass_stat"><p id="forgot_pass_stat">Sent Mail Successfully.</p></div>
