...
<head>
    ...
    <!-- Facebook -->
        ...
        <meta property="og:title" content="Polls - Digit News - News across globe in your fingertips" />
        ...
        <div class="section page-when page page-cent" id="s-topnews">
            <section class="content content_sub">
                <div id="feedcontainer" class="poll_feedcontainer">
                    <br /><br />
                    <h3>DigitNew Polls</h3>
                     <?php
                        $pollfeedobj = new dn_Controller_layer();
                        if(isset($_SESSION["userid"]) || $_SESSION["userid"]=="")
                        {
                            echo $pollfeedobj->get_poll_feeds(0,$_SESSION["userid"]);
                        }
                        else
                        {
            ...
            <footer class="p-footer p-scrolldown">
                <div style="width: 75%;float: left;padding-left: 225px;">
                    <a href=<?php $_SESSION["page"]=$_SESSION["page"]+1;echo "TopNews.php?page=".($_SESSION["page"]+1);?> >
                        <div class="arrow-d">
